...
- ROS 2
- AprilTag detection pipeline (Use the configuration parameters in "Demo_tags_36h11.yaml" from "apriltag_configurations")
- RViz
- Unitree Go2 SDK / communication setup
- Docker environment for robot execution
- Required camera drivers (Use the "params3.yaml" file from camera_configurations) and TF packages
...
## Launch in sequence on seperate terminals
