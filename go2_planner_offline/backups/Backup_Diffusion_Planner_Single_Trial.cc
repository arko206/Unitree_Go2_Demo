...
{
    // Retained for the existing classical lateral extension.
    Configuration mid;
    Configuration end;

    int parent_idx = -1;
    double eval_dist = 1e18;

    // Used by the iterative diffusion extension.
    //
    // Example:
    // q_near -> rollout[0] -> rollout[1] -> rollout[2]
...
{   
    ...
    for (int iter = 0; iter < MAX_ITERS; ++iter)
    {
        ...
        if (found)
        {
            ...
            // ========================================================
            // Case 2: Existing classical lateral extension
            // ========================================================
            else
            {
                int last_parent = near_idx;
