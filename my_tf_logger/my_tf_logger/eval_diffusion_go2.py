...
def main():
    ...
    parser.add_argument('--dataset_path', type=str,
                        default='/home/arka/Desktop/Go2_movement_collection/Front_Jump/Demo_Jump_Go2.zarr')
    ...
    base_obs_dir = "/home/arka/Demo_Report_Go2/Evaluation_Trajectories/Obs_eval"
    base_act_dir = "/home/arka/Demo_Report_Go2/Evaluation_Trajectories/Act_eval"
    ...
    ckpt_path = 'New_Demo_Jump_Unitree_100ep.ckpt'
    ...
    for iter in range(0,34):
        ...
        with open(os.path.join(base_act_dir, f"Short_Demo_Jump_diffusion_actions_{iter}.json"), "w") as f:
            json.dump(fwd_action_list_as_lists, f)

        observations_as_lists = [obs.tolist() for obs in obs_list]
        with open(os.path.join(base_obs_dir, f"Short_Demo_Jump_diffusion_observations_{iter}.json"), "w") as f:
