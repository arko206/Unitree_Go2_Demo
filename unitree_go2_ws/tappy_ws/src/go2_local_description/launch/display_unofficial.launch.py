...
def generate_launch_description():
    ...
    default_urdf = PathJoinSubstitution([pkg_share, 'urdf', 'go2_new_unofficial.urdf'])
    #default_urdf = "/home/arka/unitree_go2_ws/tappy_ws/src/go2_local_description/urdf/go2_new_unofficial.urdf"
